...
| Key Features | Focuses on better noise compression at the same number of queries.                                                                                               | - Focuses on black-box attack transferability across different models.                                                                                                      | Focuses on query efficiency, combining different attack strategies to improve overall performance.     |
